...
| Rendering | `RHSprite`, `RHSpriteScriptor`, `RHMinimap`, `RHMenuGraphics`, `RHUIRenderer*`, `RHFontManager`, `RHTitbits`, `RHWidgetPortrait`, "sprite cache", "frame cache", "shadow polygon", "light zones", a warning about unknown screen resolutions (fixed set: 640x480, 800x600, 1024x768) |
| Sound | `RHSound`, `RHSoundCache`, `RHSoundSource`, `RHSoundSourceManager`, `RHSoundGeometry`; an FMOD version check; remark categories per actor kind (soldier / civilian / VIP) |
